...
public class GoalManager
{
    ...
    public void DisplayPlayerInfo()
    {
        ...
        if (level >= 4) rank = "Journeyman";
        if (level >= 6) rank = "Master";
        if (level >= 10) rank = "Grandmaster";
    ...
    public void RecordEvent()
    {
        ...
        {
            ChecklistGoal chkGoal = (ChecklistGoal)selectedGoal;
            if (chkGoal.IsComplete())
            {
                string[] parts = chkGoal.GetStringRepresentation().Split(',');
